...
internal class ElasticSearchUI : DatabaseUI {
    ...
    override fun createResultPanel(project: Project, objectFile: NoSqlDatabaseObjectFile): NoSqlResultView {
        ...
        return ElasticsearchPanel(project, ElasticsearchContext( ElasticsearchClient.getInstance(project), elasticSearchObjectFile.configuration, elasticSearchObjectFile.collection, elasticSearchObjectFile.database))
    }
}