...
internal class PreviousPageAction(pageable: Pageable) : AbstractPageableAction(pageable, getResourceString("pagebuttons.previouspage.label"), icon = AllIcons.Actions.Left) {
