...
public class AddValueAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent anActionEvent) {
        AddValueDialog dialog = AddValueDialog.createDialog(editionPanel);
        dialog.show();
        ...
        editionPanel.addValue(dialog.getValue());
    }

    @Override
    public void update(AnActionEvent event) {
        event.getPresentation().setVisible(editionPanel.canAddValue());
    }
}