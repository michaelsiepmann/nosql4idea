...
internal class StandardDateIndexedValueDescriptor internal constructor(index: Int, value: Date) : StandardIndexedValueDescriptor<Date>(index, value, StyleAttributesProvider.getStringAttribute()) {
