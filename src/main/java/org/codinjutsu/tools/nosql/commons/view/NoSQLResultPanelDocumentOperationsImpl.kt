...
class NoSQLResultPanelDocumentOperationsImpl<SERVERCONFIGURATION : ServerConfiguration, COLLECTION : NoSQLCollection, out CLIENT : DatabaseClient<CONTEXT, DOCUMENT, SERVERCONFIGURATION, COLLECTION>, CONTEXT : DatabaseContext<CLIENT, SERVERCONFIGURATION>, RESULT : SearchResult, DOCUMENT>(private val panel: DatabasePanel<SERVERCONFIGURATION, CLIENT, CONTEXT, RESULT, DOCUMENT>) : NoSQLResultPanelDocumentOperations<DOCUMENT> {
