...
open class StandardIndexedValueDescriptor<VALUE> internal constructor(
        private val index: Int,
        private var value: VALUE,
        private val valueTextAttributes: SimpleTextAttributes
) : AbstractNodeDecriptor<VALUE>(), IndexedValueDescriptor<VALUE> {
    ...
    override fun getFormattedKey() = "[$index]"
