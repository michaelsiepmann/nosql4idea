...
package org.codinjutsu.tools.nosql.couchbase.configuration
...
class CouchbaseServerConfiguration(
    ...
    override fun copy(): ServerConfiguration =
            CouchbaseServerConfiguration(label, serverUrl, userDatabase, isConnectOnIdeStartup, authenticationSettings)
}
